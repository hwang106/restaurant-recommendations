...
# I know that you guys would add the code for the other foods types with more time. 
# If the code ends up being very similar to "brunch" and "restaurants," 
# how could you make the code more concise?
